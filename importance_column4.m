...
train_data_yes=Data_sorted_yes(permuted_yes(1:204),4);
 traindata_no=[Data_sorted_no(1:587,1:3),train_data_no(:,1)];
 traindata_yes=[Data_sorted_yes((1:204),1:3),train_data_yes(:,1)];
...
testdata_no=[Data_sorted_no(588:end,1:3),test_data_no(:,1)];
 testdata_yes=[Data_sorted_yes((205:end),1:3), test_data_yes(:,1)];
