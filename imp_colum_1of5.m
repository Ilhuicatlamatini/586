...
train_data_yes=Data_sorted_yes(permuted_yes(1:204),1);
 traindata_no=[train_data_no(:,1), Data_sorted_no(1:587,2:5)];
 traindata_yes=[train_data_yes(:,1),Data_sorted_yes((1:204),2:5)];
...
testdata_no=[test_data_no(:,1), Data_sorted_no(588:end,2:5)];
 testdata_yes=[test_data_yes(:,1),Data_sorted_yes((205:end),2:5)];
