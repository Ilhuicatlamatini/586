...
train_data_yes=Data_sorted_yes(permuted_yes(1:204),2);
 traindata_no=[Data_sorted_no(1:587,1),train_data_no(:,1), Data_sorted_no(1:587,3:4)];
 traindata_yes=[Data_sorted_yes((1:204),1),train_data_yes(:,1),Data_sorted_yes((1:204),3:4)];
...
testdata_no=[Data_sorted_no(588:end,1),test_data_no(:,1), Data_sorted_no(588:end,3:4)];
 testdata_yes=[Data_sorted_yes((205:end),1), test_data_yes(:,1),Data_sorted_yes((205:end),3:4)];
