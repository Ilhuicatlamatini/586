...
train_data_yes=Data_sorted_yes(permuted_yes(1:204),3);
 traindata_no=[Data_sorted_no(1:587,1:2),train_data_no(:,1), Data_sorted_no(1:587,4:5)];
 traindata_yes=[Data_sorted_yes((1:204),1:2),train_data_yes(:,1),Data_sorted_yes((1:204),4:5)];
...
testdata_no=[Data_sorted_no(588:end,1:2),test_data_no(:,1), Data_sorted_no(588:end,4:5)];
 testdata_yes=[Data_sorted_yes((205:end),1:2), test_data_yes(:,1),Data_sorted_yes((205:end),4:5)];
